...
@Client.on_message(command(["skip", "كب","خطي", f"skip@{BOT_USERNAME}", "vskip"]) & other_filters)
@authorized_users_only
...
@Client.on_message(
    command(["pause", "وقت", "قف" f"pause@{BOT_USERNAME}", "vpause"]) & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command(["resume", "تابعه","مل", f"resume@{BOT_USERNAME}", "vresume"]) & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command(["mute", "كوت" , f"mute@{BOT_USERNAME}", "vmute"]) & other_filters
)
@authorized_users_only
